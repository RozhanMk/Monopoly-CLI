public class BoardState {
    ...
    private BoardState(){
        ...
        fields[1] = new Empty(1 , true);
        fields[2] = new Airport(2 , false);
        fields[3] = new Cinema(3 , true);
        fields[4] = new Road(4 , false);
        fields[5] = new Reward(5 , false);
        fields[6] = new Empty(6 , true);
        fields[7] = new Cinema(7 , true);
        fields[8] = new Empty(8 , true);
        fields[9] = new Road(9 , false);
        fields[10] = new Airport(10 , false);
        fields[11] = new Empty(11 , true);
        fields[12] = new Prison(12 , false);
        fields[13] = new Empty(13 , true);
        fields[14] = new Cinema(14 , true);
        fields[15] = new Road(15 , false);
        fields[16] = new Tax(16 , false);
        fields[17] = new Empty(17 , true);
        fields[18] = new Empty(18 , true);
        fields[19] = new Airport(19 , false);
        fields[20] = new Bank(20 , false);
        fields[21] = new Cinema(21 , true);
        fields[22] = new Empty(22 , true);
